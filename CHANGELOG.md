...
Además estrena el modo **redacted-ops**: un copiloto de operaciones estrictamente de solo-lectura que responde preguntas sobre la plataforma redacted (errores, tráfico, latencias, crons, fallos de proveedores) consultando sus bitácoras en la nube y el estado de los PRs en GitHub.
