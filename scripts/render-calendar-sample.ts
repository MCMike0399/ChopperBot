...
import {
   buildCalendar,
   type IcsEvent,
} from "../src/capabilities/calendar/ics.js";
...
const events: RenderEvent[] = [
   // Sun Jun 14, weekly — Círculo "Repensar la Pobreza"
   {
      ...
      start_at: iso("2026-06-15T02:00:00Z"),
      end_at: null,
   ...
   // Mon Jun 15, weekly — Círculo "Las venas abiertas de América Latina"
   {
      ...
      start_at: iso("2026-06-16T02:00:00Z"),
      end_at: null,
      recurrence_freq: "weekly",
      recurrence_until: null,
   },
   // Sat Jun 20, one-off — Asamblea constituyente
   {
      ...
      start_at: iso("2026-06-21T02:00:00Z"),
      end_at: iso("2026-06-21T04:00:00Z"),
   ...
   // Crowd test: Wed Jun 17 has several events (forces stacking + overflow).
   {
      ...
      start_at: iso("2026-06-17T17:00:00Z"),
      end_at: null,
      recurrence_freq: null,
      recurrence_until: null,
   },
   {
      id: 5,
      title: "Comida colectiva",
      start_at: iso("2026-06-17T19:00:00Z"),
      end_at: null,
      recurrence_freq: null,
      recurrence_until: null,
   },
   {
      id: 6,
      title: "Proyección + debate: cine documental latinoamericano contemporáneo",
      start_at: iso("2026-06-17T01:00:00Z"),
      end_at: null,
      recurrence_freq: null,
      recurrence_until: null,
   },
   {
      ...
      start_at: iso("2026-06-17T23:30:00Z"),
      end_at: null,
      recurrence_freq: null,
      recurrence_until: null,
   },
   ...
   {
      id: 8,
      title: "Brigada de limpieza",
      start_at: iso("2026-06-08T15:00:00Z"),
      end_at: null,
      recurrence_freq: "daily",
      recurrence_until: iso("2026-06-13T15:00:00Z"),
   },
   // Emoji + smart punctuation, to prove sanitization.
   {
      id: 9,
      title: "🔥 ¡Fiesta! — “tardeada” antifa 🏴",
      start_at: iso("2026-06-27T20:00:00Z"),
      end_at: null,
      recurrence_freq: null,
      recurrence_until: null,
   },
   ...
   ...densityDay(
      "2026-08-03",
      2,
      "Círculo de estudio: la utopía de las normas",
   ),
   ...densityDay(
      "2026-08-04",
      3,
      "Conversatorio sobre data centers y modelos de lenguaje",
   ),
   ...densityDay(
      "2026-08-05",
      4,
      "Club de poesía: Rosario Castellanos y su obra completa",
   ),
...
console.log(
   `wrote ICS → ${resolve(OUT, "revolucion-z.ics")} (${ics.length} events)`,
);
console.log(`\nInspect: ${OUT}`);
