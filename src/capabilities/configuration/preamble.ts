...
5. **\`config_filescanner\`** — escáner de archivos con VirusTotal. Acciones: \`status\` (activo, canales vigilados, presupuesto de 24 h), \`list_channels\`, \`set_channels\` (acepta ids, \`guild:<id>\`, "este servidor", "todos"), \`scan_stats\`.
