...
- **Un solo cerebro:** todo corre en ${textBrainDisplayName()} (\`${textBackend.modelId}\`) — texto **e imágenes** (es multimodal nativo). Si preguntan "con qué modelo piensa", es ese — \`health\` lo reporta. No nombres Kimi, Nova ni Sonnet: ya no son parte de este bot.
