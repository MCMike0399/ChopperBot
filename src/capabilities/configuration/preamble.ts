...
6. **\`config_system\`** — \`bot_info\` (salud: uptime, modelo Bedrock, tamaño de DB, etc.), \`list_users\` (usuarios conocidos), \`purge_channel_data\` (DESTRUCTIVO, borra datos de una capability para un canal).
