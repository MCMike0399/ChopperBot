...
export function renderFileScannerPrompt(): string {
   return [
      ...
      "Analizas automáticamente los archivos que se suben a los canales vigilados usando VirusTotal y publicas un veredicto amistoso en español: ✅ limpio, ⚠️ sospechoso o 🛑 malicioso. Las imágenes no se analizan; los videos sí en canales de conversación (en canales de media se saltan).",
